...
def create_scenario():
    ...
    def _create_scenario(repo: git.Repo, file_master, file_working_branch):
...
def test_track_without_modification(repo: git.Repo, create_scenario, run_cli):
    ...
    with open(output_file, mode='r') as file:
        assert file.read() == "list_of_classes_to_move =[]"


def test_track_with_modification(repo: git.Repo, create_scenario, run_cli):
    imports_for_file_a = ['from a.b import c\n', 'from d.e import f\n']
    ...
    output_file = _output_file(repo)
    with open(output_file, mode='r') as file:
        assert file.read() == "list_of_classes_to_move =[('a.b.c', 'x.x.c')]"


def test_track_with_conflict(repo: git.Repo, create_scenario, run_cli):
    imports_for_file_a = ['from a.b import c\n', 'from b import c\n']
    imports_for_file_b = ['from x.x import c\n', 'from y import c\n']
    create_scenario(repo, imports_for_file_a, imports_for_file_b)
...
def test_track_save_conflict(repo: git.Repo, create_scenario, run_cli):
    imports_for_file_a = ['from a.b import c\n', 'from b import c\n',
                          'from m import n\n']
    imports_for_file_b = ['from x.x import c\n', 'from y import c\n',
                          'from w import n\n']
    ...
    output_file = _output_file(repo)
    with open(output_file, mode='r') as file:
        assert file.read() == "list_of_classes_to_move =[('m.n', 'w.n')]"
